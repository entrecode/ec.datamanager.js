...
var Asset = function(asset, dm, traversal) {
  ...
  this._negotiate = function(image, thumb, size, locale) {
    if (image && this.value.type !== 'image') {
      throw new Error('ec.datamanager.js getImage' + thumb ? 'Thumb' : '' + 'Url only works on image assets');
    }
    var asset = _.cloneDeep(this.value);
    if (!image && !thumb && asset.type !== 'image') { // for getFileUrl pic fist file and return
...
},{"es6-promise":3,"halfred":4,"lodash":9,"superagent":12,"traverson":54,"traverson-hal":13}],2:[function(require,module,exports){
...
},{"_process":57}],4:[function(require,module,exports){
...
},{"vm":58}],9:[function(require,module,exports){
(function (global){
/**
 * @license
...
},{"./immutable_stack":15,"./resource":17,"dup":6}],17:[function(require,module,exports){
...
},{"superagent":12}],21:[function(require,module,exports){
'use strict';
...
},{"resolve-url":11}],23:[function(require,module,exports){
'use strict';
...
},{"./abort_traversal":23,"./transforms/detect_content_type":38,"./transforms/get_options_for_step":46,"_process":57,"minilog":18}],27:[function(require,module,exports){
'use strict';
...
},{"jsonpath-plus":8,"minilog":18,"underscore.string":21}],29:[function(require,module,exports){
'use strict';
...
},{"_process":57,"minilog":18}],34:[function(require,module,exports){
'use strict';
...
},{"../abort_traversal":23,"../http_requests":26,"../is_continuation":27,"_process":57,"minilog":18}],46:[function(require,module,exports){
'use strict';
...
},{"minilog":18,"underscore.string":21,"url-template":55,"util":19}],52:[function(require,module,exports){
'use strict';
...
},{"./lib/builder":25,"./lib/media_type_registry":29,"./lib/media_types":30,"_process":57,"minilog":18}],55:[function(require,module,exports){
...
},{"indexof":56}],"ec.datamanager.js":[function(require,module,exports){
'use strict';
