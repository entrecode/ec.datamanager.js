...
DataManager._getFileUrl = function(assetID, locale, url) {
  return new Promise(function(resolve, reject) {
    if (!assetID) {
      reject(new Error('No assetID provided')); // TODO snake case error
    }
    ...
    req.end(function(err, res) {
      ...
      if (!res.body.hasOwnProperty('url')) {
        return reject(new Error('Could not get a valid url for asset ' + assetID)); // TODO snake case error
      }
    ...
    _getTraversal: function() {
      ...
      return new Promise(function(resolve, reject) {
        ...
        if (dm._rootTraversal) {
          rootTraversal.continue().newRequest()
