...
DataManager.prototype.modelList = function() {
  ...
  return new Promise(function(resolve, reject) {
    waitUntilDataManagerIsReady(dm, function(error, dataManager) {
      if (error) {
        return reject(error);
      }
