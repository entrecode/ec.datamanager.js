...
/**
 * Constructs a instance of DataManager SDK for a specific Data Managerj. Accepts an options object containing 'url' or
...
var DataManager = function(options) {
  ...
  this._fileUrl = this.url.replace('api/' + this.id + '/', 'files/');
 ...
 * @returns {Promise}
 */
DataManager.getFileUrl = function(assetID, locale, withUrl) {
  return new Promise(function(resolve, reject) {
    if (!assetID) {
      reject(new Error('No assetID provided'));
    }
    var req = request.get((withUrl ? withUrl : DataManager._fileUrl) + assetID + '/url');
    if (locale) {
...
DataManager.getImageUrl = function(assetID, size, locale, withUrl) {
  return new Promise(function(resolve, reject) {
    if (!assetID) {
      reject(new Error('No assetID provided'));
    }
...
DataManager.getThumbUrl = function(assetID, size, locale, withUrl) {
  return new Promise(function(resolve, reject) {
    if (!assetID) {
      reject(new Error('No assetID provided'));
    }
...
DataManager.prototype.getImageThumbURL = function(assetID, size, locale) {
  return DataManager.getThumbUrl(assetID, size, locale, this._fileUrl);
};
